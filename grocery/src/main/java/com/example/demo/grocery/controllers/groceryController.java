...
public class groceryController {
    ...
    @PostMapping("/login")
    public ConsumerEntity loginConsumer(@RequestBody ConsumerEntity consumerEntity)
    {
        int userid=consumerEntity.getId();
        ConsumerEntity c=consumerServices.validConsumerEntity(userid);
        if(c!=null)
        {
            return c;
        }
